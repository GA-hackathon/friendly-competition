...
@contest3 = Contest.create!(name: "best cocktail", category: "cocktails", rules: Faker::Lorem.sentence(word_count: 10), ending_time: DateTime.strptime("10/20/1999 17:00", "%m/%d/%Y %H:%M"), picture: "https://static.vinepair.com/wp-content/uploads/2017/11/50-best-cocktails-inside.jpg" ,user: @admin)
@contest4 = Contest.create!(name: "best cocktail", category: "cocktails", rules: Faker::Lorem.sentence(word_count: 10), ending_time: DateTime.strptime("10/20/1999 17:00", "%m/%d/%Y %H:%M"), picture: "https://static.vinepair.com/wp-content/uploads/2017/11/50-best-cocktails-inside.jpg" ,user: @admin)
@contest5 = Contest.create!(name: "best cocktail", category: "cocktails", rules: Faker::Lorem.sentence(word_count: 10), ending_time: DateTime.strptime("10/20/1999 17:00", "%m/%d/%Y %H:%M"), picture: "https://static.vinepair.com/wp-content/uploads/2017/11/50-best-cocktails-inside.jpg" ,user: @admin)
@contest6 = Contest.create!(name: "best cocktail", category: "cocktails", rules: Faker::Lorem.sentence(word_count: 10), ending_time: DateTime.strptime("10/20/1999 17:00", "%m/%d/%Y %H:%M"), picture: "https://static.vinepair.com/wp-content/uploads/2017/11/50-best-cocktails-inside.jpg" ,user: @admin)
