...
@contest10 = Contest.create!(name: "insert contenst name here", category: "cocktails", rules: Faker::Lorem.sentence(word_count: 15), ending_time: DateTime.strptime("1/20/2021 17:00", "%m/%d/%Y %H:%M"), picture: "https://i.insider.com/5c2f4534ad9571412a2cb0c3?width=1067&format=jpeg", user: @bob)
