...
@contest2 = Contest.create!(name: "Bye", category: "nope", rules: Faker::Lorem.sentence(word_count: 15), ending_time: DateTime.strptime("12/30/2020 17:00", "%m/%d/%Y %H:%M"), picture: "https://i.insider.com/5c2f4534ad9571412a2cb0c3?width=1067&format=jpeg", user: @daniel)
@contest3 = Contest.create!(name: "cool cocktail", category: "cocktails", rules: Faker::Lorem.sentence(word_count: 10), ending_time: DateTime.strptime("1/2/2021 17:00", "%m/%d/%Y %H:%M"), picture: "https://static.vinepair.com/wp-content/uploads/2017/11/50-best-cocktails-inside.jpg" ,user: @bob)
...
@contest6 = Contest.create!(name: "contest with entries and no votes", category: "cocktails", rules: Faker::Lorem.sentence(word_count: 10), ending_time: DateTime.strptime("10/20/1999 17:00", "%m/%d/%Y %H:%M"), picture: "https://images.pexels.com/photos/613037/pexels-photo-613037.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" ,user: @admin)
@contest7 = Contest.create!(name: "insert contenst name here", category: "cocktails", rules: Faker::Lorem.sentence(word_count: 15), ending_time: DateTime.strptime("1/12/2021 17:00", "%m/%d/%Y %H:%M"), picture: "https://i.insider.com/5c2f4534ad9571412a2cb0c3?width=1067&format=jpeg", user: @daniel)
@contest8 = Contest.create!(name: "insert contenst name here", category: "cocktails", rules: Faker::Lorem.sentence(word_count: 15), ending_time: DateTime.strptime("1/12/2022 17:00", "%m/%d/%Y %H:%M"), picture: "https://i.insider.com/5c2f4534ad9571412a2cb0c3?width=1067&format=jpeg", user: @daniel)
@contest9 = Contest.create!(name: "insert contenst name here", category: "cocktails", rules: Faker::Lorem.sentence(word_count: 15), ending_time: DateTime.strptime("1/10/2021 17:00", "%m/%d/%Y %H:%M"), picture: "https://i.insider.com/5c2f4534ad9571412a2cb0c3?width=1067&format=jpeg", user: @daniel)
@contest10 = Contest.create!(name: "contest with no entries and no votes", category: "cocktails", rules: Faker::Lorem.sentence(word_count: 15), ending_time: DateTime.strptime("1/20/2021 17:00", "%m/%d/%Y %H:%M"), picture: "https://i.insider.com/5c2f4534ad9571412a2cb0c3?width=1067&format=jpeg", user: @bob)
...
@submission5 = Submission.create!(name: "Tequila Sunrise Cocktail 3", content: Faker::Lorem.sentence(word_count: 30), file: "https://www.thespruceeats.com/thmb/8w9Zmdiva5L23O_HJhjgYC-jKEU=/1365x1365/smart/filters:no_upscale()/tequila-sunrise-recipe-760754-19_preview-5b02f856119fa80037651942.jpeg", user: @admin, contest: @contest2)
@submission6 = Submission.create!(name: "Tequila Sunrise Cocktail 3", content: Faker::Lorem.sentence(word_count: 30), file: "https://www.thespruceeats.com/thmb/8w9Zmdiva5L23O_HJhjgYC-jKEU=/1365x1365/smart/filters:no_upscale()/tequila-sunrise-recipe-760754-19_preview-5b02f856119fa80037651942.jpeg", user: @admin, contest: @contest6)
@submission7 = Submission.create!(name: "Tequila Sunrise Cocktail 3", content: Faker::Lorem.sentence(word_count: 30), file: "https://www.thespruceeats.com/thmb/8w9Zmdiva5L23O_HJhjgYC-jKEU=/1365x1365/smart/filters:no_upscale()/tequila-sunrise-recipe-760754-19_preview-5b02f856119fa80037651942.jpeg", user: @daniel, contest: @contest6)
